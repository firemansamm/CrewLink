...
import { DisconnectID, PacketID, RPCID, ColourID, HatID, SkinID, PetID, SystemType, TaskID, DataID, SpawnID, MessageID, GameEndReason, AlterGameTag, PayloadID, DistanceID, TaskBarUpdate, MapID, LanguageID, SpawnFlag } from "../constants/Enums.js";
import { byte, bitfield, uint8, int8, uint16, uint32, int32, float, packed, code } from "./Types.js";
...
export declare type GameOptionsData = GameOptionsDataV2 | GameOptionsDataV3 | GameOptionsDataV4;
...
export declare type DisconnectPacket = DisconnectPacketClientBound | DisconnectPacketServerBound;
...
export declare type HostGamePayload = HostGamePayloadServerBound | HostGamePayloadClientBound;
...
export declare type JoinGamePayloadClientBound = JoinGamePayloadClientBoundError | JoinGamePayloadClientBoundPlayer;
export declare type JoinGamePayload = JoinGamePayloadServerBound | JoinGamePayloadClientBound;
...
export declare type RPCCheckColor = RPCCheckColour;
export interface RPCSetColour extends RPC {
    rpcid: RPCID.SetColour;
    colour: ColourID;
    color?: ColourID;
}
export declare type RPCSetColor = RPCSetColour;
...
export declare enum PlayerDataFlags {
    Disconnected = 1,
    IsImposter = 2,
    IsImpostor = 2,
    IsDead = 4
...
export declare type RPCMessage = RPCPlayAnimation | RPCCompleteTask | RPCSyncSettings | RPCSetInfected | RPCEjected | RPCCheckName | RPCSetName | RPCCheckColour | RPCSetColour | RPCCheckColor | RPCSetColor | RPCSetHat | RPCSetSkin | RPCReportDeadBody | RPCMurderPlayer | RPCSendChat | RPCStartMeeting | RPCSetScanner | RPCSendChatNote | RPCSetPet | RPCSetStartCounter | RPCEnterVent | RPCExitVent | RPCSnapTo | RPCClose | RPCVotingComplete | RPCCastVote | RPCClearVote | RPCAddVote | RPCCloseDoorsOfType | RPCRepairSystem | RPCSetTasks | RPCUpdateGameData;
export declare enum PlayerVoteAreaFlags {
    VotedFor = 15,
    DidReport = 32,
    DidVote = 64,
    IsDead = 128
...
export declare type SpawnMessage = ShipStatusSpawn | MeetingHubSpawn | LobbySpawn | GameDataSpawn | PlayerSpawn | HeadQuartersSpawn | PlanetMapSpawn | AprilShipStatusSpawn;
export interface DespawnMessage extends Message {
    type: MessageID.Despawn;
    netid: packed;
}
export declare type SceneChangeLocation = "OnlineGame";
...
export declare type GameDataMessage = DataMessage | RPCMessage | SpawnMessage | DespawnMessage | SceneChangeMessage | ReadyMessage | ChangeSettingsMessage;
...
export declare type KickPlayerPayload = KickPlayerPayloadServerBound | KickPlayerPayloadClientBound;
...
export declare type GameListCount = {
    [K in MapID]: number;
};
export declare enum GameListClientBoundTag {
    List = 0,
    Count = 1
}
...
export declare type GameListPayload = GameListPayloadClientBoundList | GameListPayloadClientBoundCount | GameListPayloadServerBound;
export declare type Payload = HostGamePayload | JoinGamePayload | StartGamePayload | RemoveGamePayload | RemovePlayerPayload | GameDataPayload | GameDataToPayload | JoinedGamePayload | EndGamePayload | KickPlayerPayload | AlterGamePayload | RedirectPayload | MasterServerListPayload | GameListPayload;
...
export declare type PayloadPacket = ReliablePayloadPacket | UnreliablePayloadPacket;
export declare type Packet = PayloadPacket | HelloPacket | DisconnectPacket | AcknowledegePacket | PingPacket;
