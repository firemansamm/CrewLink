import { DisconnectID, DistanceID, LanguageID, MapID, MessageID, PacketID, PayloadID, RPCID, TaskBarUpdate } from "./constants/Enums.js";
...
export function composeGameOptions(options) {
    ...
    options.version = (_a = options.version) !== null && _a !== void 0 ? _a : 3;
    const writer = new BufferWriter;
    const bwrite = new BufferWriter;
    bwrite.byte(options.version);
    bwrite.uint8((_b = options.maxPlayers) !== null && _b !== void 0 ? _b : 10);
    bwrite.uint32LE((_c = options.language) !== null && _c !== void 0 ? _c : LanguageID.English);
    bwrite.byte((_d = options.mapID) !== null && _d !== void 0 ? _d : MapID.TheSkeld);
    bwrite.floatLE((_e = options.playerSpeed) !== null && _e !== void 0 ? _e : 1.0);
    bwrite.floatLE((_f = options.crewVision) !== null && _f !== void 0 ? _f : 1.0);
    bwrite.floatLE((_g = options.imposterVision) !== null && _g !== void 0 ? _g : 1.25);
    bwrite.floatLE((_h = options.killCooldown) !== null && _h !== void 0 ? _h : 25);
    bwrite.uint8((_j = options.commonTasks) !== null && _j !== void 0 ? _j : 1);
    bwrite.uint8((_k = options.longTasks) !== null && _k !== void 0 ? _k : 1);
    bwrite.uint8((_l = options.shortTasks) !== null && _l !== void 0 ? _l : 2);
    bwrite.int32LE((_m = options.emergencies) !== null && _m !== void 0 ? _m : 1);
    bwrite.uint8((_o = options.imposterCount) !== null && _o !== void 0 ? _o : 2);
    bwrite.byte((_p = options.killDistance) !== null && _p !== void 0 ? _p : DistanceID.Medium);
    bwrite.int32LE((_q = options.discussionTime) !== null && _q !== void 0 ? _q : 15);
    bwrite.int32LE((_r = options.votingTime) !== null && _r !== void 0 ? _r : 120);
    bwrite.bool((_s = options.isDefault) !== null && _s !== void 0 ? _s : false);
    if (options.version === 2 || options.version === 3 || options.version === 4) {
        bwrite.uint8((_t = options.emergencyCooldown) !== null && _t !== void 0 ? _t : 15);
    }
    if (options.version === 3 || options.version === 4) {
        bwrite.bool((_u = options.confirmEjects) !== null && _u !== void 0 ? _u : true);
        bwrite.bool((_v = options.visualTasks) !== null && _v !== void 0 ? _v : true);
    }
    if (options.version === 4) {
        bwrite.bool((_w = options.anonymousVoting) !== null && _w !== void 0 ? _w : false);
        bwrite.uint8((_x = options.taskBarUpdates) !== null && _x !== void 0 ? _x : TaskBarUpdate.Always);
    }
